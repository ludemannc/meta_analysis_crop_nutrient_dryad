...
#List columns to be converted to numeric class
cols_num <- c( "Article_ID"                           ,      
               "Year_published"                       ,   
               "Journal_vol"                          ,"Journal_iss",             
               "Experiment_Number"                    ,       
               "Plot_area"                            ,"Block"                                ,"Number_years_data"            ,   
               "Replicate_n"                          ,  
               "Replicate_num"                        ,  
               "Actual_rainfall_during trial_mm"      ,"Actual_irrigation_mm"                 ,   
               "Soil_moisture_%_WHC"                  ,"Soil_clay_%"                          ,"Soil_silt_%"                      ,   
               "Soil_sand_%"                          ,"Soil_pH_H2O_1:1_Number"               ,   
               "Soil_pH_H2O_1:2.5_Number"             ,"Soil_pH_CaCl2_Number"                 ,  
               "Soil_Bulk_density_mg_cm3"             ,"Soil_SOC_K2Cr2O7_g_C_kg"              ,"Soil_NC_Kjeldahl_g_N_kg"          ,   
               "Soil_Carbon_Wakley_Black_g_C_kg"      ,"Soil_Carbon_test_1_g_C_kg"            ,"Soil_N_(Parco2020)_kg_N_ha"       ,   
               "Soil_N_(De Silva 2008)_kg_N_ha"       ,"Soil_K_(Black)_kg_K_ha"               ,"Soil_S_available_mg_S_kg"         ,   
               "Soil_S_Mehlich-3_mg_S_kg"             ,"Soil_S_(Method 2)_mg_S_kg"            ,"Soil_P_Olsen_mg_kg"               ,   
               "Soil_P_Bray_1_mg_P_kg"                ,"Soil_P_Bray_2_mg_P_kg"                ,"Soil_P_Mehlich-3_mg_P_kg"         ,   
               "Soil_K_dry_mg_K_kg"                   ,"Soil_K_wet_mg_K_kg"                   ,"Soil_K_exchangeable_mg_K_kg"      ,   
               "Soil_K_(Mehlich-3)_mg_K_kg"           ,"Soil_K_(Method 1)_mg_K_kg"            ,"Soil_FE_DETPA_extractable_mg_kg"  ,   
               "Soil_Zn_DETPA_extractable_mg_kg"      ,"Soil_Ca_Mehlich-3_mg_Ca_kg"           ,"Soil_pH_KCl_Number"               ,   
               "Soil_OM_%"                            ,  
               "Crop_variety_release_Year"            ,   
               "Sow_density_Seeds_m2"                 ,   
               "Harvest_density_Plants_m2"            ,"Fertiliser_N_kg_N_ha"                 ,   
               "Fertiliser_P_kg_P_ha"                 ,"Fertiliser_K_kg_K_ha"                 ,"Fertiliser_S_kg_S_ha"             ,   
               "Fertiliser_Ca_kg_Ca_ha"               ,"Fertiliser_Mg_kg_Mg_ha"               ,"Fertiliser_B_kg_B_ha"             ,   
               "Fertiliser_Cl_kg_Cl_ha"               ,"Fertiliser_Cu_kg_Cu_ha"               ,"Fertiliser_Fe_kg_Fe_ha"           ,   
               ...
               "CPY_LSD_kg_fresh_ha"                  ,"CobY_mean_kg_fresh_ha"                ,"CobY_sd_kg_fresh_ha"              ,   
               "CobY_SE_kg_fresh_ha"                  ,"CobY_LSD_kg_fresh_ha"                 ,"CRY_mean_kg_fresh_ha"             ,   
               "CRY_sd_kg_fresh_ha"                   ,"CRY_SE_kg_fresh_ha"                   ,"CRY_LSD_kg_fresh_ha"              ,   
               "AGY_mean_kg_fresh_ha"                 ,"AGY_sd_kg_fresh_ha"                   ,"AGY_SE_kg_fresh_ha"               ,   
               "AGY_LSD_kg_fresh_ha"                  ,"CPY_mean_kg_DM_ha"                    ,"CPY_sd_kg_DM_ha"                  ,   
               "CPY_SE_kg_DM_ha"                      ,"CPY_LSD_kg_DM_ha"                     ,"CobY_mean_kg_DM_ha"               ,   
               "CobY_sd_kg_DM_ha"                     ,"CobY_SE_kg_DM_ha"                     ,"CobY_LSD_kg_DM_ha"                ,   
               "CRY_mean_kg_DM_ha"                    ,"CRY_sd_kg_DM_ha"                      ,"CRY_SE_kg_DM_ha"                  ,   
               "CRY_LSD_kg_DM_ha"                     ,"AGY_mean_kg_DM_ha"                    ,"AGY_sd_kg_DM_ha"                  ,   
               "AGY_SE_kg_DM_ha"                      ,"AGY_LSD_kg_DM_ha"                     ,"HI_mean_Unitless"                 ,   
               "HI_sd_Unitless"                       ,"HI_SE_Unitless"                       ,"HI_LSD_Unitless"                  ,   
               "CPCon_DM_mean_kg_DM_kg_fresh"         ,"CPCon_DM_sd_kg_DM_kg_fresh"           ,"CPCon_DM_SE_kg_DM_kg_fresh"       ,   
               "CPCon_DM_LSD_kg_DM_kg_fresh"          ,"CPCon_Prot_mean_kg_kg_DM"             ,"CPCon_Prot_sd_kg_kg_DM"           ,   
               "CPCon_Prot_SE_kg_kg_DM"               ,"CPCon_Prot_LSD_kg_kg_DM"              ,"CPCon_N_mean_kg_kg_DM"            ,   
               "CPCon_N_sd_kg_kg_DM"                  ,"CPCon_N_SE_kg_kg_DM"                  ,"CPCon_N_LSD_kg_kg_DM"             ,   
               "CPCon_P_mean_kg_kg_DM"                ,"CPCon_P_sd_kg_kg_DM"                  ,"CPCon_P_SE_kg_kg_DM"              ,   
               "CPCon_P_LSD_kg_kg_DM"                 ,"CPCon_K_mean_kg_kg_DM"                ,"CPCon_K_sd_kg_kg_DM"              ,   
               "CPCon_K_SE_kg_kg_DM"                  ,"CPCon_K_LSD_kg_kg_DM"                 ,"CPCon_S_mean_kg_kg_DM"            ,   
               "CPCon_S_sd_kg_kg_DM"                  ,"CPCon_S_SE_kg_kg_DM"                  ,"CPCon_S_LSD_kg_kg_DM"             ,   
               "CPCon_Ca_mean_kg_kg_DM"               ,"CPCon_Ca_sd_kg_kg_DM"                 ,"CPCon_Ca_SE_kg_kg_DM"             ,   
               "CPCon_Ca_LSD_kg_kg_DM"                ,"CPCon_Mg_mean_kg_kg_DM"               ,"CPCon_Mg_sd_kg_kg_DM"             ,   
               "CPCon_Mg_SE_kg_kg_DM"                 ,"CPCon_Mg_LSD_kg_kg_DM"                ,"CPCon_B_mean_kg_kg_DM"            ,   
               "CPCon_B_sd_kg_kg_DM"                  ,"CPCon_B_SE_kg_kg_DM"                  ,"CPCon_B_LSD_kg_kg_DM"             ,   
               "CPCon_Cl_mean_kg_kg_DM"               ,"CPCon_Cl_sd_kg_kg_DM"                 ,"CPCon_Cl_SE_kg_kg_DM"             ,   
               "CPCon_Cl_LSD_kg_kg_DM"                ,"CPCon_Cu_mean_kg_kg_DM"               ,"CPCon_Cu_sd_kg_kg_DM"             ,   
               "CPCon_Cu_SE_kg_kg_DM"                 ,"CPCon_Cu_LSD_kg_kg_DM"                ,"CPCon_Fe_mean_kg_kg_DM"           ,   
               "CPCon_Fe_sd_kg_kg_DM"                 ,"CPCon_Fe_SE_kg_kg_DM"                 ,"CPCon_Fe_LSD_kg_kg_DM"            ,   
               "CPCon_Mn_mean_kg_kg_DM"               ,"CPCon_Mn_sd_kg_kg_DM"                 ,"CPCon_Mn_SE_kg_kg_DM"             ,   
               "CPCon_Mn_LSD_kg_kg_DM"                ,"CPCon_Mo_mean_kg_kg_DM"               ,"CPCon_Mo_sd_kg_kg_DM"             ,   
               "CPCon_Mo_SE_kg_kg_DM"                 ,"CPCon_Mo_LSD_kg_kg_DM"                ,"CPCon_Zn_mean_kg_kg_DM"           ,   
               "CPCon_Zn_sd_kg_kg_DM"                 ,"CPCon_Zn_SE_kg_kg_DM"                 ,"CPCon_Zn_LSD_kg_kg_DM"            ,   
               "CRCon_Prot_mean_kg_kg_DM"             ,"CRCon_Prot_sd_kg_kg_DM"               ,"CRCon_Prot_SE_kg_kg_DM"           ,   
               "CRCon_Prot_LSD_kg_kg_DM"              ,"CRCon_N_mean_kg_kg_DM"                ,"CRCon_N_sd_kg_kg_DM"              ,   
               "CRCon_N_SE_kg_kg_DM"                  ,"CRCon_N_LSD_kg_kg_DM"                 ,"CRCon_P_mean_kg_kg_DM"            ,   
               "CRCon_P_sd_kg_kg_DM"                  ,"CRCon_P_SE_kg_kg_DM"                  ,"CRCon_P_LSD_kg_kg_DM"             ,   
               "CRCon_K_mean_kg_kg_DM"                ,"CRCon_K_sd_kg_kg_DM"                  ,"CRCon_K_SE_kg_kg_DM"              ,   
               "CRCon_K_LSD_kg_kg_DM"                 ,"CRCon_S_mean_kg_kg_DM"                ,"CRCon_S_sd_kg_kg_DM"              ,   
               "CRCon_S_SE_kg_kg_DM"                  ,"CRCon_S_LSD_kg_kg_DM"                 ,"CRCon_Ca_mean_kg_kg_DM"           ,   
               "CRCon_Ca_sd_kg_kg_DM"                 ,"CRCon_Ca_SE_kg_kg_DM"                 ,"CRCon_Ca_LSD_kg_kg_DM"            ,   
               "CRCon_Mg_mean_kg_kg_DM"               ,"CRCon_Mg_sd_kg_kg_DM"                 ,"CRCon_Mg_SE_kg_kg_DM"             ,   
               "CRCon_Mg_LSD_kg_kg_DM"                ,"CRCon_B_mean_kg_kg_DM"                ,"CRCon_B_sd_kg_kg_DM"              ,   
               "CRCon_B_SE_kg_kg_DM"                  ,"CRCon_B_LSD_kg_kg_DM"                 ,"CRCon_Cl_mean_kg_kg_DM"           ,   
               "CRCon_Cl_sd_kg_kg_DM"                 ,"CRCon_Cl_SE_kg_kg_DM"                 ,"CRCon_Cl_LSD_kg_kg_DM"            ,   
               "CRCon_Cu_mean_kg_kg_DM"               ,"CRCon_Cu_sd_kg_kg_DM"                 ,"CRCon_Cu_SE_kg_kg_DM"             ,   
               "CRCon_Cu_LSD_kg_kg_DM"                ,"CRCon_Fe_mean_kg_kg_DM"               ,"CRCon_Fe_sd_kg_kg_DM"             ,   
               "CRCon_Fe_SE_kg_kg_DM"                 ,"CRCon_Fe_LSD_kg_kg_DM"                ,"CRCon_Mn_mean_kg_kg_DM"           ,   
               "CRCon_Mn_sd_kg_kg_DM"                 ,"CRCon_Mn_SE_kg_kg_DM"                 ,"CRCon_Mn_LSD_kg_kg_DM"            ,   
               "CRCon_Mo_mean_kg_kg_DM"               ,"CRCon_Mo_sd_kg_kg_DM"                 ,"CRCon_Mo_SE_kg_kg_DM"             ,   
               "CRCon_Mo_LSD_kg_kg_DM"                ,"CRCon_Zn_mean_kg_kg_DM"               ,"CRCon_Zn_sd_kg_kg_DM"             ,   
               "CRCon_Zn_SE_kg_kg_DM"                 ,"CRCon_Zn_LSD_kg_kg_DM"                ,"AGCon_Prot_mean_kg_kg_DM"         ,   
               "AGCon_Prot_sd_kg_kg_DM"               ,"AGCon_Prot_SE_kg_kg_DM"               ,"AGCon_Prot_LSD_kg_kg_DM"          ,   
               "AGCon_N_mean_kg_kg_DM"                ,"AGCon_N_sd_kg_kg_DM"                  ,"AGCon_N_SE_kg_kg_DM"              ,   
               "AGCon_N_LSD_kg_kg_DM"                 ,"AGCon_P_mean_kg_kg_DM"                ,"AGCon_P_sd_kg_kg_DM"              ,   
               "AGCon_P_SE_kg_kg_DM"                  ,"AGCon_P_LSD_kg_kg_DM"                 ,"AGCon_K_mean_kg_kg_DM"            ,   
               "AGCon_K_sd_kg_kg_DM"                  ,"AGCon_K_SE_kg_kg_DM"                  ,"AGCon_K_LSD_kg_kg_DM"             ,   
               "AGCon_S_mean_kg_kg_DM"                ,"AGCon_S_sd_kg_kg_DM"                  ,"AGCon_S_SE_kg_kg_DM"              ,   
               "AGCon_S_LSD_kg_kg_DM"                 ,"AGCon_Ca_mean_kg_kg_DM"               ,"AGCon_Ca_sd_kg_kg_DM"             ,   
               "AGCon_Ca_SE_kg_kg_DM"                 ,"AGCon_Ca_LSD_kg_kg_DM"                ,"AGCon_Mg_mean_kg_kg_DM"           ,   
               "AGCon_Mg_sd_kg_kg_DM"                 ,"AGCon_Mg_SE_kg_kg_DM"                 ,"AGCon_Mg_LSD_kg_kg_DM"            ,   
               "AGCon_B_mean_kg_kg_DM"                ,"AGCon_B_sd_kg_kg_DM"                  ,"AGCon_B_SE_kg_kg_DM"              ,   
               "AGCon_B_LSD_kg_kg_DM"                 ,"AGCon_Cl_mean_kg_kg_DM"               ,"AGCon_Cl_sd_kg_kg_DM"             ,   
               "AGCon_Cl_SE_kg_kg_DM"                 ,"AGCon_Cl_LSD_kg_kg_DM"                ,"AGCon_Cu_mean_kg_kg_DM"           ,   
               "AGCon_Cu_sd_kg_kg_DM"                 ,"AGCon_Cu_SE_kg_kg_DM"                 ,"AGCon_Cu_LSD_kg_kg_DM"            ,   
               "AGCon_Fe_mean_kg_kg_DM"               ,"AGCon_Fe_sd_kg_kg_DM"                 ,"AGCon_Fe_SE_kg_kg_DM"             ,   
               "AGCon_Fe_LSD_kg_kg_DM"                ,"AGCon_Mn_mean_kg_kg_DM"               ,"AGCon_Mn_sd_kg_kg_DM"             ,   
               "AGCon_Mn_SE_kg_kg_DM"                 ,"AGCon_Mn_LSD_kg_kg_DM"                ,"AGCon_Mo_mean_kg_kg_DM"           ,   
               "AGCon_Mo_sd_kg_kg_DM"                 ,"AGCon_Mo_SE_kg_kg_DM"                 ,"AGCon_Mo_LSD_kg_kg_DM"            ,   
               "AGCon_Zn_mean_kg_kg_DM"               ,"AGCon_Zn_sd_kg_kg_DM"                 ,"AGCon_Zn_SE_kg_kg_DM"             ,   
               "AGCon_Zn_LSD_kg_kg_DM"                ,"CP_Up_N_mean_kg_ha"                   ,"CP_Up_N_sd_kg_ha"                 ,   
               "CP_Up_N_SE_kg_ha"                     ,"CP_Up_N_LSD_kg_ha"                    ,"CP_Up_P_mean_kg_ha"               ,   
               "CP_Up_P_sd_kg_ha"                     ,"CP_Up_P_SE_kg_ha"                     ,"CP_Up_P_LSD_kg_ha"                ,   
               "CP_Up_K_mean_kg_ha"                   ,"CP_Up_K_sd_kg_ha"                     ,"CP_Up_K_SE_kg_ha"                 ,   
               "CP_Up_K_LSD_kg_ha"                    ,"CP_Up_S_mean_kg_ha"                   ,"CP_Up_S_sd_kg_ha"                 ,   
               "CP_Up_S_SE_kg_ha"                     ,"CP_Up_S_LSD_kg_ha"                    ,"CP_Up_Ca_mean_kg_ha"              ,   
               "CP_Up_Ca_sd_kg_ha"                    ,"CP_Up_Ca_SE_kg_ha"                    ,"CP_Up_Ca_LSD_kg_ha"               ,   
               "CP_Up_Mg_mean_kg_ha"                  ,"CP_Up_Mg_sd_kg_ha"                    ,"CP_Up_Mg_SE_kg_ha"                ,   
               "CP_Up_Mg_LSD_kg_ha"                   ,"CP_Up_B_mean_kg_ha"                   ,"CP_Up_B_sd_kg_ha"                 ,   
               "CP_Up_B_SE_kg_ha"                     ,"CP_Up_B_LSD_kg_ha"                    ,"CP_Up_Cl_mean_kg_ha"              ,   
               "CP_Up_Cl_sd_kg_ha"                    ,"CP_Up_Cl_SE_kg_ha"                    ,"CP_Up_Cl_LSD_kg_ha"               ,   
               "CP_Up_Cu_mean_kg_ha"                  ,"CP_Up_Cu_sd_kg_ha"                    ,"CP_Up_Cu_SE_kg_ha"                ,   
               "CP_Up_Cu_LSD_kg_ha"                   ,"CP_Up_Fe_mean_kg_ha"                  ,"CP_Up_Fe_sd_kg_ha"                ,   
               "CP_Up_Fe_SE_kg_ha"                    ,"CP_Up_Fe_LSD_kg_ha"                   ,"CP_Up_Mn_mean_kg_ha"              ,  
               "CP_Up_Mn_sd_kg_ha"                    ,"CP_Up_Mn_SE_kg_ha"                    ,"CP_Up_Mn_LSD_kg_ha"               ,   
               "CP_Up_Mo_mean_kg_ha"                  ,"CP_Up_Mo_sd_kg_ha"                    ,"CP_Up_Mo_SE_kg_ha"                ,   
               "CP_Up_Mo_LSD_kg_ha"                   ,"CP_Up_Zn_mean_kg_ha"                  ,"CP_Up_Zn_sd_kg_ha"                ,   
               "CP_Up_Zn_SE_kg_ha"                    ,"CP_Up_Zn_LSD_kg_ha"                   ,"CR_Up_N_mean_kg_ha"               ,   
               "CR_Up_N_sd_kg_ha"                     ,"CR_Up_N_SE_kg_ha"                     ,"CR_Up_N_LSD_kg_ha"                ,   
               "CR_Up_P_mean_kg_ha"                   ,"CR_Up_P_sd_kg_ha"                     ,"CR_Up_P_SE_kg_ha"                 ,   
               "CR_Up_P_LSD_kg_ha"                    ,"CR_Up_K_mean_kg_ha"                   ,"CR_Up_K_sd_kg_ha"                 ,   
               "CR_Up_K_SE_kg_ha"                     ,"CR_Up_K_LSD_kg_ha"                    ,"CR_Up_S_mean_kg_ha"               ,   
               "CR_Up_S_sd_kg_ha"                     ,"CR_Up_S_SE_kg_ha"                     ,"CR_Up_S_LSD_kg_ha"                ,   
               "CR_Up_Ca_mean_kg_ha"                  ,"CR_Up_Ca_sd_kg_ha"                    ,"CR_Up_Ca_SE_kg_ha"                ,   
               "CR_Up_Ca_LSD_kg_ha"                   ,"CR_Up_Mg_mean_kg_ha"                  ,"CR_Up_Mg_sd_kg_ha"                ,   
               "CR_Up_Mg_SE_kg_ha"                    ,"CR_Up_Mg_LSD_kg_ha"                   ,"CR_Up_B_mean_kg_ha"               ,   
               "CR_Up_B_sd_kg_ha"                     ,"CR_Up_B_SE_kg_ha"                     ,"CR_Up_B_LSD_kg_ha"                ,   
               "CR_Up_Cl_mean_kg_ha"                  ,"CR_Up_Cl_sd_kg_ha"                    ,"CR_Up_Cl_SE_kg_ha"                ,   
               "CR_Up_Cl_LSD_kg_ha"                   ,"CR_Up_Cu_mean_kg_ha"                  ,"CR_Up_Cu_sd_kg_ha"                ,   
               "CR_Up_Cu_SE_kg_ha"                    ,"CR_Up_Cu_LSD_kg_ha"                   ,"CR_Up_Fe_mean_kg_ha"              ,   
               "CR_Up_Fe_sd_kg_ha"                    ,"CR_Up_Fe_SE_kg_ha"                    ,"CR_Up_Fe_LSD_kg_ha"               ,   
               "CR_Up_Mn_mean_kg_ha"                  ,"CR_Up_Mn_sd_kg_ha"                    ,"CR_Up_Mn_SE_kg_ha"                ,   
               "CR_Up_Mn_LSD_kg_ha"                   ,"CR_Up_Mo_mean_kg_ha"                  ,"CR_Up_Mo_sd_kg_ha"                ,   
               "CR_Up_Mo_SE_kg_ha"                    ,"CR_Up_Mo_LSD_kg_ha"                   ,"CR_Up_Zn_mean_kg_ha"              ,   
               "CR_Up_Zn_sd_kg_ha"                    ,"CR_Up_Zn_SE_kg_ha"                    ,"CR_Up_Zn_LSD_kg_ha"               ,   
